...
private:
	...
	int eval(const int& my_color);
	bool isEnd();
	std::pair<int, int>F3(int alpha, int beta, int depth, const int& my_color);
	std::pair<int, int>G3(int alpha, int beta, int depth, const int& my_color);
	std::pair<int, int>Star0_F3(int alpha, int beta, int depth, const int& my_color);
	std::pair<int, int>Star0_G3(int alpha, int beta, int depth, const int& my_color);
};
